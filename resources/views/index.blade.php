...
.home{
    display: flex;
    background-image: url("{{asset('images/new/banner.jpg')}}");
    ...
    <div class="max-width">
        <div class="row">
          <div class="home-content">
              ...
              <div class="text-2">EDEN HIGH</div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                        <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  <p class="card-text">Eden high school is a school committed to scholarly excellence. We have competent teachers whou are out to make the 
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                        <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  <p class="card-text">Eden high school has a list of core values that are geared towards developing the students in the right manner.
...
<script>
    ...
    var typed = new Typed(".typing", {
        strings: ["Software Analyzer", "App Developer", "Penetration Tester", "Software Engineer", "Freelancer"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
