...
<head>
        ...
        <title>Egerton - Pharmacy Dashboard</title>
		...
		<link rel="stylesheet" href="{{ asset('phamacy/plugins/morris/morris.css')}}">
    ...
    <body>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="/pharmacy/products">Products</a></li>
		...
		<script src="{{ asset('phamacy/plugins/raphael/raphael.min.js')}}"></script>    
		<script src="{{ asset('phamacy/plugins/morris/morris.min.js')}}"></script>  
		<script src="{{ asset('phamacy/js/chart.morris.js')}}"></script>
